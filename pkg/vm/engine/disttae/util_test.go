...
func TestForeachBlkInObjStatsList(t *testing.T) {
	...
	count := 0
	ForeachBlkInObjStatsListInProgress(false, nil, func(blk objectio.BlockInfo, _ objectio.BlockObject) bool {
		count++
		return false
	}, statsList...)
	...
	count = 0
	ForeachBlkInObjStatsListInProgress(true, nil, func(blk objectio.BlockInfo, _ objectio.BlockObject) bool {
		count++
		return false
	}, statsList...)
